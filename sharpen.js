...
// returns sharpened image as a new image called imageSharpen with matching filetype as input
function sharpen(imageName, fileType){
    Jimp.read(imageName+"."+fileType).then(function(image){
        ...
        for(var i=1; i<y; i++){
            for(var j=1; j<x; j++){
                ...
                image.bitmap.data[indexBottomLeft+0] = red;
                ...
                image.bitmap.data[indexBottomLeft+1] = green;
                ...
                image.bitmap.data[indexBottomLeft+2] = blue; 
                 ...
                 image.bitmap.data[indexBottomLeft+3] = alpha; 
            }
        }
