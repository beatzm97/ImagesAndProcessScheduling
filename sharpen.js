    ...
    Jimp.read(imageName+"."+fileType).then(function(image){
        ...
        for(var i=1; i<y; i++){
            for(var j=1; j<x; j++){
                ...
                image.bitmap.data[indexTopRight+0] = red;
                ...
                image.bitmap.data[indexTopRight+1] = green;
                ...
                image.bitmap.data[indexTopRight+2] = blue; 
                 ...
                 image.bitmap.data[indexTopRight+3] = alpha; 
            }
        }
